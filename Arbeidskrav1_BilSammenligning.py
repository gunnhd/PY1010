...
def yearly_car_cost(
    yearly_km, insurance_cost, yearly_traffic_insurance, cost_pr_km, toll_pr_km):

    yearly_car_cost = (
        insurance_cost
        + yearly_traffic_insurance
        + yearly_km * cost_pr_km
        + yearly_km * toll_pr_km
    )
...
# Calculate cost for gasoline car
gasoline_car_cost = yearly_car_cost(
    yearly_km,
    insurance_gasoline_car,
    yearly_traffic_insurance,
    gasoline_cost_pr_km,
    toll_gasoline_pr_km,
)

# Calculate cost for electric car
electric_car_cost = yearly_car_cost(
    yearly_km,
    insurance_electric_car,
    yearly_traffic_insurance,
    electricity_cost_pr_km,
    toll_electric_pr_km,
)
